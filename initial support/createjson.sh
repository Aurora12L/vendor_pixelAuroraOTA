...
zip="pixelAurora zip" #ex: crDroidAndroid-<android version>-<date>-<device codename>-v<pixelaurora version>.zip
...
commondt="" #https://github.com/Aurora12L/android_device_<orm>_<SOC>-common
  ...
  "response": [
    {
        ...
        "device": "'$devicename'",
        "filename": "'$zip_only'",
        "download": "https://sourceforge.net/projects/pixelaurora12l/files/'$device'/'$v_max'.x/'$zip_only'/download",
        "timestamp": '$timestamp',
        "md5": "'$md5'",
        "sha256": "'$sha256'",
        "size": '$size',
