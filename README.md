# pixelAurora OTA repo
In order for a device to be officially supported by pixelAurora, OTA information needs to be added.
  ...
  "response": [
    {
        ...
        "oem": "OEM",
        "device": "Device Name",
        "filename": "pixelAurora-12L-<date>-<device codename>-v<version>.zip",
        "download": "https://sourceforge.net/projects/pixelaurora12l/files/<device codename>/<crversion>/pixelAurora-12L-<date>-<device codename>-v<version>.zip/download",
        ...
        "dt": "https://github.com/Aurora12L/android_device_<oem>_<device_codename>",
        "common-dt": "https://github.com/Aurora12L/android_device_<orm>_<SOC>-common",
        "kernel": "https://github.com/Aurora12L/android_kernel_<oem>_<SOC>"
    }
  ]
}
```
...
## 2 Guidelines ##
* Check if your device has all [requirements](https://github.com/Aurora12L/rules-and-guidelines#builds-quality-requirements) to be officially supported
...
### 3.1 Initial support ###
After you contacted [Drogon on Telegram](https://telegram.me/Drogon_99), and have the approval, follow the below steps.
1. Fork this repo to your own GitHub
2. Copy file **createjson.sh** from *initial support* folder to pixelAurora source folder and make it executable
```
...
./createjson.sh
```
4. A file named *codename*.json gets created in main pixelAurora source folder. Copy it to where this repo was cloned.
...
```
git clone https://github.com/Aurora12L/vendor_pixelAuroraOTA -b 12L
```
2. Change to the directory where you cloned this repo (vendor_pixelAuroraOTA) and fetch updates from repo.
```
cd vendor_pixelAuroraOTA
git fetch --all
git pull
```
3. Copy *codename*.json file from out dir (where your pixelAurora zip is compiled) over to this repo folder (vendor_pixelAuroraOTA).
